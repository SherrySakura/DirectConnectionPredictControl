...
namespace DirectConnectionPredictControl.CommenTool
{
    ...
    public class SliverDataContainer
    {
        ...
        /// 1轴检测速度
        /// </summary>
        private int speedShaft1;

        /// <summary>
        /// 2轴检测速度
        /// </summary>
        private int speedShaft2;
        ...
        /// 1轴检测速度
        /// </summary>
        public int SpeedShaft1 { get => speedShaft1; set => speedShaft1 = value; }

        /// <summary>
        /// 2轴检测速度
        /// </summary>
        public int SpeedShaft2 { get => speedShaft2; set => speedShaft2 = value; }
